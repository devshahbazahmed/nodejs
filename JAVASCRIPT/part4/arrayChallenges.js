...
const hardCopyCities = JSON.parse(JSON.stringify(topCities));

console.log(hardCopyCities);

/* 
8. You have two arrays: `europeanCities` containing `"Paris"` and `"Rome"` and `asianCities` contianing `"Tokyo"` and `"Bangkok"`. Merge these two arrays into a new array named `worldCities`. 
*/
